...
Shows the landing page with Drag & Drop CSV upload.

![Home Page](./images/home-page.png)

---

### 2. CSV Uploaded Successfully

Displays the uploaded CSV file information including file name and total rows detected.
...
Preview of the uploaded CSV before AI processing.

![CSV Preview](./images/csv-preview.png)

---

### 4. Import Processing

After clicking **Confirm Import**, the AI processes the uploaded CSV and extracts CRM records.

![Import Processing](./images/import-processing.png)

---

### 5. Final Import Result

Shows the import summary with:
